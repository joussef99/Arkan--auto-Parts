...
export const InvoiceView: React.FC<InvoiceViewProps> = ({
  ...
  const exportAsPDF = () => {
    ...
    toJpeg(invoiceRef.current, { quality: 0.95, backgroundColor: "#fff" })
      .then((dataUrl) => {
        ...
        void savePdfBytes(bytes, `INV-${invoiceId}.pdf`);
      })
  ...
  const sendWhatsApp = () => {
    ...
    window.open(
      `https://wa.me/${invoice.customer_phone || ""}?text=${encodeURIComponent(summary)}`,
      "_blank",
    );
  };
  ...
  if (!invoice) {
    return (
      <div className="text-center text-red-500 p-8">الفاتورة غير موجودة</div>
    );
  }
  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
      <div className="p-4 border-b border-slate-100 bg-slate-50 flex justify-between items-center shrink-0">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-emerald-50 text-emerald-700 rounded-xl font-bold hover:bg-emerald-100 transition-all"
          >
      ...
      <div className="flex-1 overflow-auto p-8 custom-scrollbar bg-slate-50">
        <div
          ref={invoiceRef}
          className="max-w-4xl mx-auto bg-white p-10 shadow-sm border border-slate-200 rounded-2xl"
          dir="rtl"
        >
          <div className="flex justify-between items-start border-b-4 border-emerald-600 pb-8 mb-8">
            ...
            <div className="text-left">
              <h2 className="text-4xl font-black text-emerald-600 uppercase mb-2">
                فاتورة مبيعات
              </h2>
              <div className="space-y-1 text-lg">
                <p>
                  ...
                  <span className="font-mono font-bold">INV-{invoice.id}</span>
                </p>
                <p>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
              ...
              <div className="space-y-3 text-lg">
                <p className="flex justify-between border-b border-slate-200 pb-2">
                  ...
                  <span className="font-bold">
                    {invoice.customer_name || "زبون نقدي"}
                  </span>
                </p>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
              ...
              <div className="space-y-3 text-lg">
                ...
                <p className="flex justify-between">
                  ...
                  <span
                    className={`font-bold ${remainingBalance <= 0 ? "text-emerald-600" : "text-red-600"}`}
                  >
          ...
          <table className="w-full mb-10 border-collapse">
            <thead>
              <tr className="bg-emerald-600 text-white">
                <th className="p-4 text-right rounded-tr-xl font-bold">
                  الصنف
                </th>
                ...
                <th className="p-4 text-center rounded-tl-xl font-bold">
                  الإجمالي
                </th>
              </tr>
            </thead>
            <tbody>
              {invoice.items.map((item: any, idx: number) => (
                ...
                >
                  ...
                  <td className="p-4 border-b border-slate-200 text-center font-mono text-slate-600">
                    {item.oem_number}
                  </td>
                  ...
                  <td className="p-4 border-b border-slate-200 text-center font-black text-emerald-600">
          ...
          <div className="flex justify-between items-end">
            ...
            <div className="w-96 space-y-3 bg-slate-50 border border-slate-200 p-6 rounded-2xl">
              <div className="flex justify-between text-lg text-slate-600">
                ...
                <span className="font-bold">
                  {invoice.total_amount + invoice.discount} د.ل
                </span>
              </div>
              <div className="flex justify-between text-lg text-slate-600">
              ...
              <div className="flex justify-between text-lg text-slate-600">
                <span>المتبقي:</span>
                <span
                  className={`font-bold ${remainingBalance > 0 ? "text-red-600" : "text-slate-600"}`}
                >
          ...
          <div className="mt-16 text-center text-slate-400 text-sm border-t border-slate-200 pt-8">
            <p>
              البضاعة المباعة لا ترد ولا تستبدل إلا بوجود الفاتورة الأصلية خلال
              3 أيام من تاريخ الشراء.
            </p>
